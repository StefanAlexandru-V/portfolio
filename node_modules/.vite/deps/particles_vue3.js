...
var Options = class {
  constructor(engine, container2) {
    ...
    __classPrivateFieldSet$9(this, _Options_engine, engine, "f");
    __classPrivateFieldSet$9(this, _Options_container, container2, "f");
    this.autoPlay = true;
    ...
    this.particles = loadParticlesOptions(__classPrivateFieldGet$8(this, _Options_engine, "f"), __classPrivateFieldGet$8(this, _Options_container, "f"));
  ...
  load(data) {
    ...
    __classPrivateFieldGet$8(this, _Options_engine, "f").plugins.loadOptions(this, data);
    ...
    this.defaultDarkTheme = (_d = __classPrivateFieldGet$8(this, _Options_instances, "m", _Options_findDefaultTheme).call(this, "dark")) === null || _d === void 0 ? void 0 : _d.name;
    this.defaultLightTheme = (_e = __classPrivateFieldGet$8(this, _Options_instances, "m", _Options_findDefaultTheme).call(this, "light")) === null || _e === void 0 ? void 0 : _e.name;
  }
  setTheme(name) {
    if (name) {
      ...
      const mediaMatch = typeof matchMedia !== "undefined" && matchMedia("(prefers-color-scheme: dark)"), clientDarkMode = mediaMatch && mediaMatch.matches, defaultTheme = __classPrivateFieldGet$8(this, _Options_instances, "m", _Options_findDefaultTheme).call(this, clientDarkMode ? "dark" : "light");
      if (defaultTheme) {
  ...
  importPreset(preset) {
    this.load(__classPrivateFieldGet$8(this, _Options_engine, "f").plugins.getPreset(preset));
  }
};
...
function drawParticle(container2, context, particle, delta, colorStyles, backgroundMask, composite, radius, opacity, shadow) {
...
var Canvas = class {
  constructor(container2) {
    ...
    __classPrivateFieldSet$7(this, _Canvas_context, null, "f");
  ...
  loadCanvas(canvas) {
    ...
    __classPrivateFieldSet$7(this, _Canvas_context, this.element.getContext("2d"), "f");
  ...
  drawParticle(particle, delta) {
    ...
    this.draw((ctx) => {
      ...
      drawParticle(container2, ctx, particle, delta, colorStyles, options.backgroundMask.enable, options.backgroundMask.composite, radius * zSizeFactor, zOpacity, particle.options.shadow);
      for (const updater of container2.particles.updaters) {
  ...
  draw(cb) {
    if (!__classPrivateFieldGet$6(this, _Canvas_context, "f")) {
      return;
    }
    return cb(__classPrivateFieldGet$6(this, _Canvas_context, "f"));
  }
  initCover() {
...
var _sfc_main = defineComponent({
  ...
  mounted() {
    nextTick(async () => {
      ...
      let loadedContainer = await (this.url ? tsParticles.loadJSON(this.id, this.url) : tsParticles.load(this.id, (_a = this.options) != null ? _a : {}));
      cb(loadedContainer);
    });
  },
  beforeMount() {
...
var particles = _export_sfc(_sfc_main, [["render", _sfc_render]]);
